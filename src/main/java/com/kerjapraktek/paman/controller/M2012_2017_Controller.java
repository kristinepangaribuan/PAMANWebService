...
public class M2012_2017_Controller {
    ...
    @RequestMapping(value = "/update/{BTKI_2012}", method = RequestMethod.PUT)
    public M2012_2017 updateM2012_2017 (@PathVariable("BTKI_2012")String BTKI_2012, @RequestBody M2012_2017 m2012_2017){
        M2012_2017 update = m2012_2017_service.findM2012_2017ById(BTKI_2012);
    ...
    @RequestMapping(value = "/delete/{BTKI_2012}", method = RequestMethod.DELETE)
    public void deleteM2012_2017ById(@PathVariable("BTKI_2012")String BTKI_2012){m2012_2017_service.deleteM2012_2017ById(BTKI_2012);}
}
